    ...
    <header className="">
      <div className="flex items-center justify-between ">
        ...
        <div className=" hidden md:flex lg:flex  gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
          ...
          <div className=" border-l border-gray-300"></div>
          <div>Add Guests</div>
          <button className="bg-[#FF630B] text-white p-1 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <Link
          ...
          className="flex items-center gap-2 border bg-[#FF630B] text-white border-gray-300 rounded-full py-2 px-4 "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
